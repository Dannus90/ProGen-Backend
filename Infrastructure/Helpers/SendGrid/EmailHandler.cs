...
namespace API.helpers.SendGrid
{
    public class EmailHandler : IEmailHandler
    {
        ...
        private string GenerateResetPasswordHtml(string resetPasswordLink, string baseUrl)
        {
            var htmlBody = "<!doctype html><html lang='en-US'>" +
                           "<head>" +
                           ...
                           @"<img width='60' src='https://res.cloudinary.com/dfq1maxu9/image/upload/v1621455831/ProGen/ProGenLogoBig_abevrt.png' title='logo' alt='logo' />" +
                           "</a></td></tr><tr><td style='height:20px;'>&nbsp;</td></tr><tr><td>" +
                           ...
                           "<p style='font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;'>&copy; <strong>" + baseUrl + "</strong></p>" +
                           "</td></tr><tr><td style='height:80px;'>&nbsp;</td></tr></table>" +
